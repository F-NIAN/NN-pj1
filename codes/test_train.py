...
train_images_path = r'c:\Users\lenovo\Desktop\神经网络与深度学习\PJ1\codes\dataset\MNIST\train-images-idx3-ubyte.gz'
train_labels_path = r'c:\Users\lenovo\Desktop\神经网络与深度学习\PJ1\codes\dataset\MNIST\train-labels-idx1-ubyte.gz'
...
linear_model = nn.models.Model_MLP([train_imgs.shape[-1], 600, 10], 'ReLU', [1e-4, 1e-4], None)
...
runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], num_epochs=3, log_iters=100, save_dir=r'C:\Users\lenovo\Desktop\神经网络与深度学习\PJ1\codes\best_models')
